...
# })
# mn = MovieNetwork.create(movie_id: 78, network_id: 6)

# mg = MovieGenre.create(movie_id: 78, genre_id: 7)
# mg = MovieGenre.create(movie_id: 78, genre_id: 10)
# Movie.create({
...
# })
# mn = MovieNetwork.create(movie_id: 79, network_id: 5)

# mg = MovieGenre.create(movie_id: 79, genre_id: 4)
# mg = MovieGenre.create(movie_id: 79, genre_id: 14)
